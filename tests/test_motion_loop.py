...
class GLWidget(QOpenGLWidget):
    ...
    def initializeGL(self):
        ...
        self.model.LoadModelJson(
            r"Resources/v2/model/test.model.json")#这里使用下面的模型
        ...
        def on_motion_started(a, b):
            print(f"{a}_{b} 动作播放开始")

        def on_motion_finished(a, b):
            print("动作播放结束")
            self.model.StartMotion(a, b, 3, on_motion_started, on_motion_finished)

        self.model.StartMotion("idle_3",0,3, on_motion_started, on_motion_finished)
